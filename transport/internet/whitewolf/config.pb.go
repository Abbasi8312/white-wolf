...
// 	protoc        v3.21.12
// source: transport/internet/whitewolf/config.proto
...
func (x *Config) Reset() {
	*x = Config{}
	mi := &file_transport_internet_whitewolf_config_proto_msgTypes[0]
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_transport_internet_whitewolf_config_proto_rawDescGZIP(), []int{0}
}
...
func (x *LimitFallback) Reset() {
	*x = LimitFallback{}
	mi := &file_transport_internet_whitewolf_config_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LimitFallback) Descriptor() ([]byte, []int) {
	return file_transport_internet_whitewolf_config_proto_rawDescGZIP(), []int{1}
}
...
var File_transport_internet_whitewolf_config_proto protoreflect.FileDescriptor

const file_transport_internet_whitewolf_config_proto_rawDesc = "" +
	"\n" +
	")transport/internet/whitewolf/config.proto\x12!xray.transport.internet.whitewolf\"\x9c\x06\n" +
	"\x06Config\x12\x12\n" +
	...
	"\fmldsa65_seed\x18\v \x01(\fR\vmldsa65Seed\x12d\n" +
	"\x15limit_fallback_upload\x18\f \x01(\v20.xray.transport.internet.whitewolf.LimitFallbackR\x13limitFallbackUpload\x12h\n" +
	"\x17limit_fallback_download\x18\r \x01(\v20.xray.transport.internet.whitewolf.LimitFallbackR\x15limitFallbackDownload\x12 \n" +
	...
	"\x13burst_bytes_per_sec\x18\x03 \x01(\x04R\x10burstBytesPerSecB\x85\x01\n" +
	"%com.xray.transport.internet.whitewolfP\x01Z6github.com/xtls/xray-core/transport/internet/whitewolf\xaa\x02!Xray.Transport.Internet.Whitewolfb\x06proto3"

var (
	file_transport_internet_whitewolf_config_proto_rawDescOnce sync.Once
	file_transport_internet_whitewolf_config_proto_rawDescData []byte
)

func file_transport_internet_whitewolf_config_proto_rawDescGZIP() []byte {
	file_transport_internet_whitewolf_config_proto_rawDescOnce.Do(func() {
		file_transport_internet_whitewolf_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_transport_internet_whitewolf_config_proto_rawDesc), len(file_transport_internet_whitewolf_config_proto_rawDesc)))
	})
	return file_transport_internet_whitewolf_config_proto_rawDescData
}

var file_transport_internet_whitewolf_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_transport_internet_whitewolf_config_proto_goTypes = []any{
	(*Config)(nil),        // 0: xray.transport.internet.whitewolf.Config
	(*LimitFallback)(nil), // 1: xray.transport.internet.whitewolf.LimitFallback
}
var file_transport_internet_whitewolf_config_proto_depIdxs = []int32{
	1, // 0: xray.transport.internet.whitewolf.Config.limit_fallback_upload:type_name -> xray.transport.internet.whitewolf.LimitFallback
	1, // 1: xray.transport.internet.whitewolf.Config.limit_fallback_download:type_name -> xray.transport.internet.whitewolf.LimitFallback
...
func init() { file_transport_internet_whitewolf_config_proto_init() }
func file_transport_internet_whitewolf_config_proto_init() {
	if File_transport_internet_whitewolf_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_transport_internet_whitewolf_config_proto_rawDesc), len(file_transport_internet_whitewolf_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_transport_internet_whitewolf_config_proto_goTypes,
		DependencyIndexes: file_transport_internet_whitewolf_config_proto_depIdxs,
		MessageInfos:      file_transport_internet_whitewolf_config_proto_msgTypes,
	}.Build()
	File_transport_internet_whitewolf_config_proto = out.File
	file_transport_internet_whitewolf_config_proto_goTypes = nil
	file_transport_internet_whitewolf_config_proto_depIdxs = nil
}
